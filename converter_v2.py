...
def main(args):
    ...
    chems_f = src.factories.ChemicalsFactory('data/chemicals.json','data/chemical_alias.json', 'data/chem_group_members.json')
    stocks_f = src.factories.StocksFactory('data/stocks.json')
    phcurve_f = src.factories.PhCurveFactory('data/ph_curves.json', 'data/ph_points.json', stocks_f)
